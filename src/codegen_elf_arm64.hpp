...
namespace llgo
{
    namespace codegen
    {
        class ELFARM64Codegen
        {
        public:
            // symbolName: exported function symbol (e.g. "main", "_start", "foo")
        ...
        private:
                          ...
                          const std::vector<std::uint8_t>& symtab)
            {
                ...
                sh_sym.sh_link       = 3; // .strtab
                sh_sym.sh_info       = 1; // first global symbol
